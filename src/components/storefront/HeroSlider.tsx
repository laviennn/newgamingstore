        ...
        {sliders.length > 0 ? (
          sliders.map((url: string, index: number) => (
            <CarouselItem key={index}>
              <div className="relative h-[250px] sm:h-[300px] md:h-[400px] lg:h-[450px] w-full rounded-2xl bg-muted overflow-hidden flex items-center justify-center ring-1 ring-border shadow-2xl">
