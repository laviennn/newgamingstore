        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/20">
            <div className="space-y-0.5">
              <label htmlFor="is_maintenance" className="text-sm font-medium">Maintenance Mode</label>
              <p className="text-xs text-muted-foreground">Active maintenance mode will block access to the storefront.</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input type="checkbox" name="is_maintenance" id="is_maintenance" className="sr-only peer" defaultChecked={tenant?.is_maintenance} />
