    ...
    <div className="space-y-6">
      ...
      {waChannelActive && (
        <div className="bg-[#0a1410] border border-[#1a3328] rounded-2xl p-6 flex flex-col items-start gap-4 relative overflow-hidden">
          {/* Watermark WA Icon */}
          <svg className="absolute -right-8 -bottom-8 w-48 h-48 fill-emerald-500 opacity-5" viewBox="0 0 24 24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#121212] border border-white/5 rounded-2xl p-5 md:p-6 relative flex flex-col justify-between h-full">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/member/profile" className="bg-blue-500 hover:bg-blue-400 text-white font-semibold px-4 py-1.5 rounded-full text-xs flex items-center gap-1.5 transition-colors shadow-lg shadow-blue-500/20">
            ...
            <div className="mb-5 inline-flex bg-white/5 border border-white/10 px-2.5 py-1 rounded-md">
              <span className="text-[10px] font-bold text-gray-300 uppercase tracking-wider">{level}</span>
            </div>
        ...
        <div className="bg-[#121212] border border-white/5 rounded-2xl p-5 md:p-6 flex flex-col justify-between h-full">
          <div>
            ...
            <div className="mt-8">
              <span className="text-xs font-bold text-gray-500 tracking-wider">SALDO AKUN</span>
              <div className="text-4xl font-black text-white mt-1">
                <span className="text-gray-400 font-bold text-2xl mr-1">Rp</span> {currentBalance.toLocaleString('id-ID')}
              </div>
            </div>
          </div>
        </div>
