...
import { Zap, HeadphonesIcon, ShieldCheck, ChevronDown, Star } from "lucide-react";
...
export default async function GameTopUpPage({
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className={`container mx-auto px-4 ${gameDetailBanner ? '-mt-12 lg:-mt-20' : 'pt-10'} relative z-10 max-w-7xl`}>
          ...
          <div className="lg:w-[35%] space-y-6">
            ...
            <div className="flex gap-5">
              <div className="relative w-32 h-44 rounded-2xl overflow-hidden shadow-2xl border-[3px] border-border shrink-0 bg-muted">
                <Image src={game.image_url || "https://assets.newgamingstore.com/placeholder.png"} alt={game.name} fill sizes="128px" className="object-cover" />
              </div>
              <div className="pt-2 text-white flex flex-col justify-center">
                <h1 className="text-2xl md:text-3xl font-extrabold uppercase drop-shadow-lg tracking-tight">{game.name}</h1>
                <p className="text-sm md:text-base opacity-90 drop-shadow-md font-medium mt-1 text-primary">{game.developer || "Official Developer"}</p>
                ...
                <div className="flex flex-col gap-2 mt-4">
                  ...
                  <div className="inline-flex items-center text-[11px] font-bold bg-blue-500/20 text-blue-400 px-3 py-1.5 rounded-full border border-blue-500/30 w-fit backdrop-blur-sm">
                    <HeadphonesIcon className="w-3.5 h-3.5 mr-1.5" /> Layanan Chat 24/7
                  </div>
