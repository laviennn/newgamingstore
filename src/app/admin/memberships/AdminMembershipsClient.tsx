...
export function AdminMembershipsClient({ initialPackages }: { initialPackages: any[] }) {
  ...
  const handleConfirmDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      const { error } = await supabase.from("membership_packages").delete().eq("id", pkgToDelete.id);
